...
Senfi.prototype = {
  ...
  subscribeCommand(subscriptionOptions) {
    return new Promise((resolve, reject) => {
      ...
      try {
        this._httpRequest('post', '/subscribe/command', options, function(res) {
          resolve(res);
        });
      } catch (ex) {
        reject({
   ...
   */
  generateEvent(eventDefId, type, embeddedInputs, eventParams) {
    return new Promise((resolve, reject) => {
      ...
      try {
        this._httpRequest('post', '/event', options, function(res) {
          resolve(res);
        });
      } catch (ex) {
        reject({
   ...
   * @param {object} data
   */
  sendCommandRequest(requestId, measurementCode, priority, ttl, timeout, data) {
    return new Promise((resolve, reject) => {
      let options = {
      ...
      try {
        this._httpRequest('post', '/command/request', options, function(res) {
          resolve(res);
        });
      } catch (ex) {
        reject({
   ...
   * @param {*} data
   */
  acknowledgeCommand(messageId, measurementCode, data) {
    return new Promise((resolve, reject) => {
      let options = {
      ...
      try {
        this._httpRequest('post', '/command/acknowledge', options, function(res) {
          resolve(res);
        });
      } catch (ex) {
        reject({
